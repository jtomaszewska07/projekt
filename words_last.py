...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\!!!!!!!!!!!!!!download\\words (3) (1).py',
...
text_22 = visual.TextStim(win=win, name='text_22',
    text='Miejscem, w którym przebywa obecnie [imię] jest [x].\n\n\nAby przejść dalej naciśnij spację',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
question_component = visual.TextStim(win=win, name='question_component',
    text='Czy uważasz że [imię] jest dobrą osobą?',
    font='Arial',
...
text_27 = visual.TextStim(win=win, name='text_27',
    text='[imię] lubi czytać książki [x].\n\nAby przejść dalej naciśnij spację. ',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
# --- Initialize components for Routine "subliminal_phase_power_1" ---
cross_1 = visual.ShapeStim(
    win=win, name='cross_1', vertices='cross',units='cm', 
    size=(0.5, 0.5),
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=1.0, depth=-1.0, interpolate=True)
premask_D_1 = visual.TextStim(win=win, name='premask_D_1',
    text='',
    font='Arial',
    pos=(0, -0.0025), height=0.066, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=1.0, 
    languageStyle='LTR',
    depth=-2.0);
sub_D_1 = visual.TextStim(win=win, name='sub_D_1',
    text='',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=1.0, 
    languageStyle='LTR',
    depth=-3.0);
postmask_D_1 = visual.TextStim(win=win, name='postmask_D_1',
    text='',
    font='Arial',
    pos=(0, -0.0025), height=0.066, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=1.0, 
...
semantic_priming_test = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('stimuli_file_cal_power.xlsx', selection=rows),
...
for thisSemantic_priming_test in semantic_priming_test:
    ...
    # keep track of which components have finished
    pytanieComponents = [text_22, key_resp_22]
...
# completed 1 repeats of 'semantic_priming_test'
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    pytanie2Components = [text_23, key_resp_23]
    ...
    if key_resp_23.keys != None:  # we had a response
        ...
        trials.addData('key_resp_23.duration', key_resp_23.duration)
    ...
    trials.addData('response_awareness_test_1.keys',response_awareness_test_1.keys)
    if response_awareness_test_1.keys != None:  # we had a response
        trials.addData('response_awareness_test_1.rt', response_awareness_test_1.rt)
        trials.addData('response_awareness_test_1.duration', response_awareness_test_1.duration)
...
trials_2 = data.TrialHandler(nReps=2.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('stimuli_file_cal_power.xlsx'),
...
for thisTrial_2 in trials_2:
    ...
    # keep track of which components have finished
    pytanie3Components = [text_25, key_resp_25]
...
for thisTrial_3 in trials_3:
    ...
    # keep track of which components have finished
    pytanie4Components = [text_27, key_resp_27]
...
for thisTrial_4 in trials_4:
    ...
    # keep track of which components have finished
    pytanie5Components = [text_28, key_resp_28]
    ...
    # --- Prepare to start Routine "subliminal_phase_power_1" ---
    continueRoutine = True
    # update component parameters for each repeat
    # Run 'Begin Routine' code from mask_version_1
    if maskgen==1:
        premaskA = mask101
        postmaskA = mask102
        premaskB = mask103
    ...
    premask_D_1.setColor(color, colorSpace='rgb')
    premask_D_1.setText(premaskD)
    sub_D_1.setColor(color, colorSpace='rgb')
    sub_D_1.setText(sub_test)
    postmask_D_1.setColor(color, colorSpace='rgb')
    postmask_D_1.setText(postmaskD)
    # keep track of which components have finished
    subliminal_phase_power_1Components = [cross_1, premask_D_1, sub_D_1, postmask_D_1]
    for thisComponent in subliminal_phase_power_1Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Run Routine "subliminal_phase_power_1" ---
    routineForceEnded = not continueRoutine
    while continueRoutine:
        # get current time
        t = routineTimer.getTime()
        ...
        # if cross_1 is stopping this frame...
        if cross_1.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > cross_1.tStartRefresh + 1.5-frameTolerance:
                # keep track of stop time/frame for later
                cross_1.tStop = t  # not accounting for scr refresh
                cross_1.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'cross_1.stopped')
                # update status
                cross_1.status = FINISHED
                cross_1.setAutoDraw(False)
        
        # *premask_D_1* updates
        
        # if premask_D_1 is starting this frame...
        if premask_D_1.status == NOT_STARTED and cross_1.status==FINISHED:
            # keep track of start time/frame for later
            premask_D_1.frameNStart = frameN  # exact frame index
            premask_D_1.tStart = t  # local t and not account for scr refresh
            premask_D_1.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(premask_D_1, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'premask_D_1.started')
            # update status
            premask_D_1.status = STARTED
            premask_D_1.setAutoDraw(True)
        
        # if premask_D_1 is active this frame...
        if premask_D_1.status == STARTED:
            # update params
            pass
        
        # if premask_D_1 is stopping this frame...
        if premask_D_1.status == STARTED:
            if frameN >= (premask_D_1.frameNStart + mask_level/frames_calc):
                # keep track of stop time/frame for later
                premask_D_1.tStop = t  # not accounting for scr refresh
                premask_D_1.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'premask_D_1.stopped')
                # update status
                premask_D_1.status = FINISHED
                premask_D_1.setAutoDraw(False)
        
        # *sub_D_1* updates
        
        # if sub_D_1 is starting this frame...
        if sub_D_1.status == NOT_STARTED and premask_D_1.status==FINISHED:
            # keep track of start time/frame for later
            sub_D_1.frameNStart = frameN  # exact frame index
            sub_D_1.tStart = t  # local t and not account for scr refresh
            sub_D_1.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(sub_D_1, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'sub_D_1.started')
            # update status
            sub_D_1.status = STARTED
            sub_D_1.setAutoDraw(True)
        
        # if sub_D_1 is active this frame...
        if sub_D_1.status == STARTED:
            # update params
            pass
        
        # if sub_D_1 is stopping this frame...
        if sub_D_1.status == STARTED:
            if frameN >= (sub_D_1.frameNStart + main_sub_level/frames_calc):
                # keep track of stop time/frame for later
                sub_D_1.tStop = t  # not accounting for scr refresh
                sub_D_1.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'sub_D_1.stopped')
                # update status
                sub_D_1.status = FINISHED
                sub_D_1.setAutoDraw(False)
        
        # *postmask_D_1* updates
        
        # if postmask_D_1 is starting this frame...
        if postmask_D_1.status == NOT_STARTED and sub_D_1.status==FINISHED:
            # keep track of start time/frame for later
            postmask_D_1.frameNStart = frameN  # exact frame index
            postmask_D_1.tStart = t  # local t and not account for scr refresh
            postmask_D_1.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(postmask_D_1, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'postmask_D_1.started')
            # update status
            postmask_D_1.status = STARTED
            postmask_D_1.setAutoDraw(True)
        
        # if postmask_D_1 is active this frame...
        if postmask_D_1.status == STARTED:
            # update params
            pass
        
        # if postmask_D_1 is stopping this frame...
        if postmask_D_1.status == STARTED:
            if frameN >= (postmask_D_1.frameNStart + final_mask_level/frames.calc):
                # keep track of stop time/frame for later
                postmask_D_1.tStop = t  # not accounting for scr refresh
                postmask_D_1.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'postmask_D_1.stopped')
                # update status
                postmask_D_1.status = FINISHED
                postmask_D_1.setAutoDraw(False)
    ...
    # --- Ending Routine "subliminal_phase_power_1" ---
    for thisComponent in subliminal_phase_power_1Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # the Routine "subliminal_phase_power_1" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
